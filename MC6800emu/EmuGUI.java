...
public class EmuGUI extends JFrame implements ActionListener {
	...
	public void initEmu() {
		...
		MemoryArray memArray = new MemoryArray();
	}
	...
	public void layoutBottom() {
		...
		modifyMemoryButton = new JButton("Modify Memory");
	...
	public void actionPerformed(ActionEvent ae) {
		...
		// action if modify memory clicked
		if (ae.getSource() == modifyMemoryButton) {
			...
			if ((addressToModify != null) && (addressToModify.length() > 0)) {
				...
				if (addressToModify.charAt(0) == '$') {
					...
					System.out.println("hexy - $ " + addressToModify);
				...
				System.out.println("address entered as String = "
						+ addressToModify + "\naddress entered as decimal = "
						+ memAddress);
